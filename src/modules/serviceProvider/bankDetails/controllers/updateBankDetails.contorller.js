...
const updateBankDetailsController = catchAsync(async (req, res) => {
    ...
    const updateResult = await Services.updateBankDetailsService(id, body);
...
module.exports = updateBankDetailsController;